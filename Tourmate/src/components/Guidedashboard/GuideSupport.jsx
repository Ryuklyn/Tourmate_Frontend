    ...
    <div className="min-h-screen bg-gray-50 p-6 flex flex-col items-center">
      ...
      <div className="bg-white shadow rounded-2xl p-6 w-full max-w-4xl mt-10">
        <h2 className="text-xl font-semibold flex items-center gap-2">
          <UserCheck className="w-5 h-5 text-[#0faf94]" />
          Contact Guide Support
        </h2>

        <p className="text-gray-500 text-sm mb-4">
          Need help with bookings, payouts, or verification? Send us a message.
        </p>
        ...
        <div className="flex flex-col gap-4">
          <input
            type="text"
            placeholder="Subject"
            className="w-full border border-gray-300 rounded-xl p-3 focus:outline-[#0faf94]"
          />
          ...
          <button className="bg-[#0faf94] text-white px-6 py-3 rounded-xl w-full">
            Send Message
          </button>
        </div>
      </div>
