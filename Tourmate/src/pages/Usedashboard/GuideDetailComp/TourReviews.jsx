...
import TourReviewsSection from "./TourReviewSection";
import { getTourReviews } from "../../../services/review";
...
export default function TourReviews({ tourId }) {
    ...
    return (
        ...
        // <TourReviewsSection guideId={guideId} onAddReview={addReview} />
        ...
        <section>
            <div className="mt-6 overflow-auto w-full">
                ...
                <div className="w-full max-w-3xl">
                    ...
                    {/* Add Review */}
                    <TourReviewsSection  tourId = {tourId} onAddReview={addReview} />
                </div>
            </div>
        </section>
    );
